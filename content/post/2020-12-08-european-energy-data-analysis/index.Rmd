...
Next I used the dataset that I made with the summarized 2018 energy data to make 2 bar graphs that compare all the European Countries based on the percentage of their total energy output was made up of Renewable Energy and of Clean Energy in 2018, respectively.
...
ggplot(data_18, aes(x = country, y = renew_2018/total_2018)) +
  ...
  ggtitle("Percentage of Total Energy Production that was Renewable by European Country in 2018") +
  theme_economist() +
...
ggplot(data_18, aes(x = country, y = (renew_2018 + nuclear_2018)/total_2018)) +
  ...
  ggtitle("Percentage of Total Energy Production that was Clean by European Country in 2018") +
  theme_economist() +
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5)) +
  theme(plot.title = element_text(size = 11))
```
...
Which European country made the biggest shift towards renewable energy from 2016 to 2018?
...
ggplot(big_shift, aes(x = reorder(country, -shift), y = shift)) +
  ...
  ggtitle("The 10 European Countries with the biggest shift towards Renewable Energy from 2016 to 2018") +
  theme_economist() +
