...
dat %>%
  ...
  ggplot(aes(x = reorder(team_name, -avr_home), y = avr_home)) +
    geom_col() +
    labs(x = "Team", y = "Home Attendences") +
...
When is the optimal time and day for a NFL game to receive the highest attendance? To find this, I joined the attendance dataset and the games dataset to compare attendances over different times and dates.
